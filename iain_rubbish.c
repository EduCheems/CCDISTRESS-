...
int main() {
  ...
  int P[GRIDSIZE][GRIDSIZE][6];  // P is a 4x4 grid
  int F[16];    // F containins the available positions left in the grid
  int W[GRIDSIZE][GRIDSIZE];  // W is the Winning Sets
  
  char name[3][5] = {"Uno", "Dos", "Tres"}; // name is a string array that contains the names of the players
  int Uno[16], Tres[16];                    // players' moves
